...
module A4DecidableHandin where
...
-- Refined and split each until found a contradiction and filled in ()
...
-- Split each until found a contradiction filled in () or became refl
...
-- split these proofs into cases at which point they are refl
...
-- For _⇔-dec used ⊥-elim for ⇔-dec to give a/b out of nothing
