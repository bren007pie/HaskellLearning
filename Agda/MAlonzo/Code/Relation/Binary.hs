...
data T16
  = C17 MAlonzo.Code.Relation.Binary.Core.T578
        (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
        (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
name36 = "Relation.Binary.IsPreorder.isEquivalence"
d36 :: T16 -> MAlonzo.Code.Relation.Binary.Core.T578
d36 v0
  = case coe v0 of
      C17 v1 v2 v3 -> coe v1
...
d44 v0
  = coe (MAlonzo.Code.Relation.Binary.Core.d594 (coe (d36 (coe v0))))
...
du46 v0
  = coe
      (\ v1 v2 v3 ->
         MAlonzo.Code.Relation.Binary.Core.du600 (coe (d36 (coe v0))) v1)
name48 = "Relation.Binary.IsPreorder.Eq.sym"
d48 :: T16 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d48 v0
  = coe (MAlonzo.Code.Relation.Binary.Core.d596 (coe (d36 (coe v0))))
name50 = "Relation.Binary.IsPreorder.Eq.trans"
d50 ::
  T16 ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d50 v0
  = coe (MAlonzo.Code.Relation.Binary.Core.d598 (coe (d36 (coe v0))))
...
du52 v0 v1
  = coe
      d38 v0 v1 v1
      (coe MAlonzo.Code.Relation.Binary.Core.d594 (d36 (coe v0)) v1)
...
du54 v0 v1 v2 v3 v4 v5
  = coe
      ...
      (coe
         d38 v0 v3 v2
         (coe
            MAlonzo.Code.Relation.Binary.Core.d596 (d36 (coe v0)) v2 v3 v4))
      v5
...
d100 :: T74 -> MAlonzo.Code.Relation.Binary.Core.T578
...
du118 v0
  = let v1 = d96 (coe v0) in
    coe
      (\ v2 v3 v4 ->
         MAlonzo.Code.Relation.Binary.Core.du600 (coe (d36 (coe v1))) v2)
...
d128 a0 a1 = ()
newtype T128 = C1037 MAlonzo.Code.Relation.Binary.Core.T578
...
d144 :: T128 -> MAlonzo.Code.Relation.Binary.Core.T578
d144 v0
  = case coe v0 of
      C1037 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d148 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d594 (coe (d144 (coe v0))))
...
du150 v0
  = coe
      (\ v1 v2 v3 ->
         MAlonzo.Code.Relation.Binary.Core.du600 (coe (d144 (coe v0))) v1)
name152 = "Relation.Binary.Setoid._.sym"
d152 :: T128 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d152 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d596 (coe (d144 (coe v0))))
...
d154 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d598 (coe (d144 (coe v0))))
...
du158 v0
  = coe
      (\ v1 v2 v3 v4 -> C807 v4) erased erased erased (du156 (coe v0))
name168 = "Relation.Binary.IsDecEquivalence"
d168 a0 a1 a2 a3 = ()
data T168
  = C1251 MAlonzo.Code.Relation.Binary.Core.T578
          (AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Nullary.T14)
name182 = "Relation.Binary.IsDecEquivalence.isEquivalence"
d182 :: T168 -> MAlonzo.Code.Relation.Binary.Core.T578
d182 v0
  = case coe v0 of
      C1251 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d188 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d594 (coe (d182 (coe v0))))
...
du190 v0
  = coe
      (\ v1 v2 v3 ->
         MAlonzo.Code.Relation.Binary.Core.du600 (coe (d182 (coe v0))) v1)
name192 = "Relation.Binary.IsDecEquivalence._.sym"
d192 :: T168 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d192 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d596 (coe (d182 (coe v0))))
...
d194 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d598 (coe (d182 (coe v0))))
name200 = "Relation.Binary.DecSetoid"
d200 a0 a1 = ()
newtype T200 = C1393 T168
...
d222 :: T200 -> MAlonzo.Code.Relation.Binary.Core.T578
...
du226 v0
  = let v1 = d216 (coe v0) in
    coe
      (\ v2 v3 v4 ->
         MAlonzo.Code.Relation.Binary.Core.du600 (coe (d182 (coe v1))) v2)
...
du232 v0
  = coe
      (\ v1 v2 v3 -> C1037 v3) erased erased (d182 (coe (d216 (coe v0))))
...
data T250
  = C1577 T16 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d274 :: T250 -> MAlonzo.Code.Relation.Binary.Core.T578
...
d332 :: T304 -> MAlonzo.Code.Relation.Binary.Core.T578
...
du352 v0
  = let v1 = d326 (coe v0) in
    ...
    coe
      (\ v3 v4 v5 ->
         MAlonzo.Code.Relation.Binary.Core.du600 (coe (d36 (coe v2))) v3)
...
d402 :: T372 -> MAlonzo.Code.Relation.Binary.Core.T578
...
d436 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  (AgdaAny -> AgdaAny -> ()) ->
  T372 -> MAlonzo.Code.Relation.Binary.Core.T578
d436 v0 v1 v2 v3 v4 v5 v6 = du436 v6
du436 :: T372 -> MAlonzo.Code.Relation.Binary.Core.T578
...
d484 :: T452 -> MAlonzo.Code.Relation.Binary.Core.T578
...
d508 ::
  ...
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  T452 -> MAlonzo.Code.Relation.Binary.Core.T578
d508 v0 v1 v2 v3 = du508 v3
du508 :: T452 -> MAlonzo.Code.Relation.Binary.Core.T578
du508 v0
  = let v1 = d474 (coe v0) in
...
du512 v0
  = let v1 = d474 (coe v0) in
    ...
    coe
      (\ v3 v4 v5 ->
         MAlonzo.Code.Relation.Binary.Core.du600 (coe (d182 (coe v2))) v3)
...
du518 v0
  = coe
      (\ v1 v2 v3 v4 -> C1911 v4) erased erased erased
...
du526 v0
  = coe
      (\ v1 v2 v3 -> C1393 v3) erased erased
...
du538 :: T452 -> MAlonzo.Code.Relation.Binary.Core.T578
du538 v0
...
data T564
  = C3361 MAlonzo.Code.Relation.Binary.Core.T578
          (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
          MAlonzo.Code.Agda.Builtin.Sigma.T14
name586 = "Relation.Binary.IsStrictPartialOrder.isEquivalence"
d586 :: T564 -> MAlonzo.Code.Relation.Binary.Core.T578
d586 v0
  = case coe v0 of
      C3361 v1 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
du598 v0
  = coe
      (\ v1 v2 v3 ->
         MAlonzo.Code.Relation.Binary.Core.du600 (coe (d586 (coe v0))) v1)
name600 = "Relation.Binary.IsStrictPartialOrder.Eq.sym"
d600 :: T564 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d600 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d596 (coe (d586 (coe v0))))
...
d602 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d598 (coe (d586 (coe v0))))
...
d660 :: T622 -> MAlonzo.Code.Relation.Binary.Core.T578
...
du668 v0
  = let v1 = d644 (coe v0) in
    coe
      (\ v2 v3 v4 ->
         MAlonzo.Code.Relation.Binary.Core.du600 (coe (d586 (coe v1))) v2)
...
d726 :: T686 -> MAlonzo.Code.Relation.Binary.Core.T578
...
du742 v0
  = coe
      (C1251 (coe (d586 (coe (d706 (coe v0))))) (coe (d708 (coe v0))))
...
d748 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  (AgdaAny -> AgdaAny -> ()) ->
  T686 -> MAlonzo.Code.Relation.Binary.Core.T578
d748 v0 v1 v2 v3 v4 v5 v6 = du748 v6
du748 :: T686 -> MAlonzo.Code.Relation.Binary.Core.T578
...
d806 :: T764 -> MAlonzo.Code.Relation.Binary.Core.T578
...
d818 ::
  ...
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  T764 -> MAlonzo.Code.Relation.Binary.Core.T578
d818 v0 v1 v2 v3 = du818 v3
du818 :: T764 -> MAlonzo.Code.Relation.Binary.Core.T578
du818 v0
...
du828 v0
  = coe
      (\ v1 v2 v3 v4 -> C4079 v4) erased erased erased
...
du844 :: T764 -> MAlonzo.Code.Relation.Binary.Core.T578
...
d896 :: T870 -> MAlonzo.Code.Relation.Binary.Core.T578
...
d956 :: T928 -> MAlonzo.Code.Relation.Binary.Core.T578
...
du980 v0
  = let v1 = d950 (coe v0) in
    ...
    coe
      (\ v4 v5 v6 ->
         MAlonzo.Code.Relation.Binary.Core.du600 (coe (d36 (coe v3))) v4)
...
d1034 :: T1004 -> MAlonzo.Code.Relation.Binary.Core.T578
d1034 v0
...
d1062 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  (AgdaAny -> AgdaAny -> ()) ->
  T1004 -> MAlonzo.Code.Relation.Binary.Core.T578
d1062 v0 v1 v2 v3 v4 v5 v6 = du1062 v6
du1062 :: T1004 -> MAlonzo.Code.Relation.Binary.Core.T578
du1062 v0
  = coe (d36 (coe (d268 (coe (d888 (coe (d1024 (coe v0))))))))
...
d1110 :: T1078 -> MAlonzo.Code.Relation.Binary.Core.T578
d1110 v0
  = coe
      (d36
...
d1138 ::
  ...
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  T1078 -> MAlonzo.Code.Relation.Binary.Core.T578
d1138 v0 v1 v2 v3 = du1138 v3
du1138 :: T1078 -> MAlonzo.Code.Relation.Binary.Core.T578
du1138 v0
  = let v1 = d1100 (coe v0) in
...
du1148 v0
  = coe
      (\ v1 v2 v3 v4 -> C5785 v4) erased erased erased
...
du1170 :: T1078 -> MAlonzo.Code.Relation.Binary.Core.T578
du1170 v0
  = coe
      (d36
         (coe (d268 (coe (d888 (coe (d1024 (coe (d1100 (coe v0))))))))))
...
data T1196
  = C7259 MAlonzo.Code.Relation.Binary.Core.T578
          (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
          (AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Binary.Core.T322)
name1216 = "Relation.Binary.IsStrictTotalOrder.isEquivalence"
d1216 :: T1196 -> MAlonzo.Code.Relation.Binary.Core.T578
d1216 v0
  = case coe v0 of
      C7259 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
du1226 :: T1196 -> T168
du1226 v0
  = coe (C1251 (coe (d1216 (coe v0))) (coe (du1222 (coe v0))))
...
d1232 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  (AgdaAny -> AgdaAny -> ()) ->
  T1196 -> MAlonzo.Code.Relation.Binary.Core.T578
d1232 v0 v1 v2 v3 v4 v5 v6 = du1232 v6
du1232 :: T1196 -> MAlonzo.Code.Relation.Binary.Core.T578
...
du1234 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d594 (coe (d1216 (coe v0))))
...
du1238 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d596 (coe (d1216 (coe v0))))
...
du1240 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Core.d598 (coe (d1216 (coe v0))))
...
du1248 v0 v1
  = coe
      (\ v2 v3 v4 v5 -> C3361 v2 v4 v5) (d1216 (coe v1)) erased
...
d1306 :: T1262 -> MAlonzo.Code.Relation.Binary.Core.T578
...
du1312 v0 v1
  = coe
      (\ v2 v3 v4 v5 -> C4079 v5) erased erased erased
...
d1326 ::
  ...
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  T1262 -> MAlonzo.Code.Relation.Binary.Core.T578
d1326 v0 v1 v2 v3 = du1326 v3
du1326 :: T1262 -> MAlonzo.Code.Relation.Binary.Core.T578
