...
d32 ::
  ...
  MAlonzo.Code.Agda.Primitive.T4 ->
  (AgdaAny -> AgdaAny -> ()) ->
  MAlonzo.Code.Relation.Binary.Core.T578 ->
...
du32 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Indexed.Heterogeneous.C33
         (coe (\ v1 -> MAlonzo.Code.Relation.Binary.Core.d594 (coe v0)))
         (coe (\ v1 v2 -> MAlonzo.Code.Relation.Binary.Core.d596 (coe v0)))
         (coe
            (\ v1 v2 v3 -> MAlonzo.Code.Relation.Binary.Core.d598 (coe v0))))
name58
...
du58 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Indexed.Heterogeneous.C839
...
du130 v0
  = coe
      (\ v1 v2 v3 v4 ->
         MAlonzo.Code.Relation.Binary.Indexed.Heterogeneous.C1325 v4)
