...
du402 v0 v1 v2
  = let v3 = coe v0 v1 v2 in
    case coe v3 of
      MAlonzo.Code.Relation.Binary.Core.C342 v4
        -> coe (\ v7 -> MAlonzo.Code.Relation.Nullary.C26) erased
      MAlonzo.Code.Relation.Binary.Core.C350 v5
        -> coe (MAlonzo.Code.Relation.Nullary.C22 (coe v5))
      MAlonzo.Code.Relation.Binary.Core.C358 v6
        -> coe (\ v7 -> MAlonzo.Code.Relation.Nullary.C26) erased
      _ -> MAlonzo.RTE.mazUnreachableError
...
du474 v0 v1 v2 v3
  = let v4 = coe v1 v2 v3 in
    case coe v4 of
      MAlonzo.Code.Relation.Binary.Core.C342 v5 -> coe v5
...
name656 = "Relation.Binary.Consequences._.map-NonEmpty"
d656 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Relation.Binary.Core.T542 ->
  MAlonzo.Code.Relation.Binary.Core.T542
d656 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 = du656 v8 v9
du656 ::
  (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Relation.Binary.Core.T542 ->
  MAlonzo.Code.Relation.Binary.Core.T542
du656 v0 v1
  = coe
      (MAlonzo.Code.Relation.Binary.Core.C568
         (coe (MAlonzo.Code.Relation.Binary.Core.d562 (coe v1)))
         (coe (MAlonzo.Code.Relation.Binary.Core.d564 (coe v1)))
         (coe
            v0 (MAlonzo.Code.Relation.Binary.Core.d562 (coe v1))
            (MAlonzo.Code.Relation.Binary.Core.d564 (coe v1))
            (MAlonzo.Code.Relation.Binary.Core.d566 (coe v1))))
