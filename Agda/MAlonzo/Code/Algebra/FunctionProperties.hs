...
d94 ::
  ...
  (AgdaAny -> AgdaAny) -> (AgdaAny -> AgdaAny -> AgdaAny) -> ()
d94 = erased
name102 = "Algebra.FunctionProperties._DistributesOverˡ_"
d102 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  ...
  (AgdaAny -> AgdaAny -> AgdaAny) -> ()
d102 = erased
name114 = "Algebra.FunctionProperties._DistributesOverʳ_"
d114 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
...
d200 ::
  ...
  (AgdaAny -> AgdaAny -> ()) -> (AgdaAny -> AgdaAny -> AgdaAny) -> ()
d200 = erased
name204 = "Algebra.FunctionProperties.Congruent₁"
d204 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () -> (AgdaAny -> AgdaAny -> ()) -> (AgdaAny -> AgdaAny) -> ()
d204 = erased
name208 = "Algebra.FunctionProperties.Congruent₂"
d208 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
