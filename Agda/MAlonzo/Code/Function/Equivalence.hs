...
data T16
  = C1 MAlonzo.Code.Function.Equality.T16
...
du56 v0 v1
  = coe
      (C1
         (coe
            MAlonzo.Code.Relation.Binary.PropositionalEquality.du196
            (coe
               (\ v2 v3 v4 -> MAlonzo.Code.Relation.Binary.C1037 v4) erased erased
               (MAlonzo.Code.Relation.Binary.Core.C3153 erased erased erased))
            v0)
         (coe
            MAlonzo.Code.Relation.Binary.PropositionalEquality.du196
            (coe
...
du100 :: T16 -> T16
du100 v0 = coe (C1 (coe (d36 (coe v0))) (coe (d34 (coe v0))))
...
du118
  = coe
      ...
      (MAlonzo.Code.Relation.Binary.Core.C3153
...
du154 ::
  ...
  T16 -> T16
du154 v0 v1 v2
  = coe (C1 (coe v0 (d34 (coe v2))) (coe v1 (d36 (coe v2))))
