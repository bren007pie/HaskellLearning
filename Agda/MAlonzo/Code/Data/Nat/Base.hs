...
d184 = erased
name190 = "Data.Nat.Base.Ordering"
d190 a0 a1 = ()
data T190 = C196 Integer | C200 | C206 Integer
name212 = "Data.Nat.Base.compare"
d212 :: Integer -> Integer -> T190
d212 v0 v1
  = case coe v0 of
      0 -> case coe v1 of
             0 -> coe (\ v2 -> C200) erased
             _ -> let v2 = subInt (coe v1) (coe (1 :: Integer)) in
                  coe (\ v3 v4 -> C196 v4) erased v2
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           case coe v1 of
             0 -> coe (\ v3 v4 -> C206 v4) erased v2
             _ -> let v3 = subInt (coe v1) (coe (1 :: Integer)) in
                  coe (d212 (coe v2) (coe v3))
