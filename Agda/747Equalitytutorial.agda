...
cong f refl = refl -- this is done here?

-- Congruence with two arguments. Still important
...
cong₂ f {u} refl v≡y =  cong (f u) v≡y  -- use {u} to bring implicity u into scope
...
-- even substitution defined. Also linked to "Leibniz equality"
